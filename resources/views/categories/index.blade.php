<x-layout>
    <div x-data="{dialog: false, category: null}" class="flex w-[100%] items-center justify-center">
        ...
        <dialog x-show="dialog" x-on:click.outside="dialog = false" open class="rounded-lg bg-slate-100 shadow-md px-[3rem] py-4 flex flex-col items-center absolute top-[50%] left-[50%] -translate-[50%]">
